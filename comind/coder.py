...
You should propose exactly ONE code cell per iteration and I'll tell you the output of your code cell. If you successfully produce {self.submission_name}, please report the final verification metric in the following way:
